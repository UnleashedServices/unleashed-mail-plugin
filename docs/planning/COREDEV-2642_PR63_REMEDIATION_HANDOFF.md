...
4. `isolated-agy-review.sh:46` — claims the wrapper still defaults to `gemini-3.1-pro-high` against
   an adjacent change. **Verify against `agy --help` before acting** — gap 6 was resolved that way
   and the wrapper was found correct.
...
8. **Gaps 18–19.** `CHANGELOG.md` claims COREDEV-2605 and COREDEV-2617 passed their gates; the
